...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-7">
            ...
            <!--注册界面上的文字-->
            <div class="row">
                <div class="col-md-4 col-md-offset-2 " id="register-title">注册</div>
            </div>
            <div class="row">
                <div class="col-md-10 col-md-offset-2 ">请提供以下信息以完成注册</div>
            </div>
            <div class="row">
            ...
            <form class="form-horizontal" action="/register" method="post" onsubmit="return check()">
                ...
                <div class="row register-modify">
                    <div class="col-md-10 col-md-offset-2 "><label for="username-text">用户名</label></div>
                </div>
                <div class="row">
                    <div class="col-lg-9 col-lg-offset-2 col-md-9 col-md-offset-2 col-sm-11 ">
                        <input type="text" id="username-text" name="username" placeholder="用户名" class="form-control"  />  </div>
                </div>
                ...
                <!--密码-->
                <div class="row register-modify">
                    <div class="col-md-10 col-md-offset-2"><label for="password-text">密码</label></div>
                </div>
                <div class="row">
                    <div class="col-lg-9 col-lg-offset-2 col-md-9 col-md-offset-2 col-sm-11 ">
                        <input type="password" id="password-text" name="password" placeholder="密码" class="form-control"/> </div>
                </div>
                <div class="row height-get">
                    <div class="col-md-4 col-md-offset-2" id="password-tip"></div>
                </div>
                <!--确认密码-->
                <div class="row register-modify">
                    <div class="col-md-10 col-md-offset-2"><label for="confirm-text">确认密码</label></div>
                </div>
                <div class="row">
                    <div class="col-lg-9 col-lg-offset-2 col-md-9 col-md-offset-2 col-sm-11 "><input type="password" id="confirm-text" placeholder="确认密码" class="form-control"/> </div>
                </div>
                <div class="row height-get">
                    <div class="col-md-4 col-md-offset-2" id="confirm-tip"></div>
                </div>
